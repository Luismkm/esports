  ...
  return (
    <div className="pt-1 mt-8 bg-nlw-gradient self-stretch rounded-lg overflow-hidden">
      <div className="bg-[#2A2634] px-8 py-6 flex flex-col sm:flex-row justify-between items-center">
        <div>
          <strong className="pb-4 sm:pb-0 text-base sm:text-2xl text-white font-black block">Não encontrou seu duo?</strong>
          <span className="hidden sm:block text-zinc-400">Publique um anúncio para encontrar novos players!</span>
        </div>
